...
main(int argc, char** argv)
{
	...
	// inject test script
	duk_eval_string_noresult(g_duktape, "function game() { Abort(GetVersion()); while (true) { Rectangle(10, 10, 100, 100, CreateColor(0, 0, 255, 128)); Rectangle(80, 80, 100, 100, CreateColor(255, 0, 0, 128)); FlipScreen(); } }");
