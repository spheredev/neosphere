...
init_persons_api(void)
{
	...
	register_api_func(g_duk, NULL, "CreatePerson", js_CreatePerson);
	register_api_func(g_duk, NULL, "DestroyPerson", js_DestroyPerson);
	register_api_func(g_duk, NULL, "IsCommandQueueEmpty", js_IsCommandQueueEmpty);
	register_api_func(g_duk, NULL, "IsIgnoringPersonObstructions", js_IsIgnoringPersonObstructions);
	register_api_func(g_duk, NULL, "IsIgnoringTileObstructions", js_IsIgnoringTileObstructions);
	register_api_func(g_duk, NULL, "IsPersonObstructed", js_IsPersonObstructed);
	register_api_func(g_duk, NULL, "IsPersonVisible", js_IsPersonVisible);
	register_api_func(g_duk, NULL, "DoesPersonExist", js_DoesPersonExist);
	register_api_func(g_duk, NULL, "GetCurrentPerson", js_GetCurrentPerson);
	register_api_func(g_duk, NULL, "GetObstructingPerson", js_GetObstructingPerson);
	register_api_func(g_duk, NULL, "GetObstructingTile", js_GetObstructingTile);
	register_api_func(g_duk, NULL, "GetPersonAngle", js_GetPersonAngle);
	register_api_func(g_duk, NULL, "GetPersonBase", js_GetPersonBase);
	register_api_func(g_duk, NULL, "GetPersonData", js_GetPersonData);
	register_api_func(g_duk, NULL, "GetPersonDirection", js_GetPersonDirection);
	register_api_func(g_duk, NULL, "GetPersonFollowDistance", js_GetPersonFollowDistance);
	register_api_func(g_duk, NULL, "GetPersonFollowers", js_GetPersonFollowers);
	register_api_func(g_duk, NULL, "GetPersonFrame", js_GetPersonFrame);
	register_api_func(g_duk, NULL, "GetPersonFrameNext", js_GetPersonFrameNext);
	register_api_func(g_duk, NULL, "GetPersonFrameRevert", js_GetPersonFrameRevert);
	register_api_func(g_duk, NULL, "GetPersonIgnoreList", js_GetPersonIgnoreList);
	register_api_func(g_duk, NULL, "GetPersonLayer", js_GetPersonLayer);
	register_api_func(g_duk, NULL, "GetPersonLeader", js_GetPersonLeader);
	register_api_func(g_duk, NULL, "GetPersonList", js_GetPersonList);
	register_api_func(g_duk, NULL, "GetPersonMask", js_GetPersonMask);
	register_api_func(g_duk, NULL, "GetPersonOffsetX", js_GetPersonOffsetX);
	register_api_func(g_duk, NULL, "GetPersonOffsetY", js_GetPersonOffsetY);
	register_api_func(g_duk, NULL, "GetPersonSpeedX", js_GetPersonSpeedX);
	register_api_func(g_duk, NULL, "GetPersonSpeedY", js_GetPersonSpeedY);
	register_api_func(g_duk, NULL, "GetPersonSpriteset", js_GetPersonSpriteset);
	register_api_func(g_duk, NULL, "GetPersonValue", js_GetPersonValue);
	register_api_func(g_duk, NULL, "GetPersonX", js_GetPersonX);
	register_api_func(g_duk, NULL, "GetPersonXFloat", js_GetPersonXFloat);
	register_api_func(g_duk, NULL, "GetPersonY", js_GetPersonY);
	register_api_func(g_duk, NULL, "GetPersonYFloat", js_GetPersonYFloat);
	register_api_func(g_duk, NULL, "GetTalkDistance", js_GetTalkDistance);
	register_api_func(g_duk, NULL, "SetDefaultPersonScript", js_SetDefaultPersonScript);
	register_api_func(g_duk, NULL, "SetPersonAngle", js_SetPersonAngle);
	register_api_func(g_duk, NULL, "SetPersonData", js_SetPersonData);
	register_api_func(g_duk, NULL, "SetPersonDirection", js_SetPersonDirection);
	register_api_func(g_duk, NULL, "SetPersonFollowDistance", js_SetPersonFollowDistance);
	register_api_func(g_duk, NULL, "SetPersonFrame", js_SetPersonFrame);
	register_api_func(g_duk, NULL, "SetPersonFrameNext", js_SetPersonFrameNext);
	register_api_func(g_duk, NULL, "SetPersonFrameRevert", js_SetPersonFrameRevert);
	register_api_func(g_duk, NULL, "SetPersonIgnoreList", js_SetPersonIgnoreList);
	register_api_func(g_duk, NULL, "SetPersonLayer", js_SetPersonLayer);
	register_api_func(g_duk, NULL, "SetPersonMask", js_SetPersonMask);
	register_api_func(g_duk, NULL, "SetPersonOffsetX", js_SetPersonOffsetX);
	register_api_func(g_duk, NULL, "SetPersonOffsetY", js_SetPersonOffsetY);
	register_api_func(g_duk, NULL, "SetPersonScaleAbsolute", js_SetPersonScaleAbsolute);
	register_api_func(g_duk, NULL, "SetPersonScaleFactor", js_SetPersonScaleFactor);
	register_api_func(g_duk, NULL, "SetPersonScript", js_SetPersonScript);
	register_api_func(g_duk, NULL, "SetPersonSpeed", js_SetPersonSpeed);
	register_api_func(g_duk, NULL, "SetPersonSpeedXY", js_SetPersonSpeedXY);
	register_api_func(g_duk, NULL, "SetPersonSpriteset", js_SetPersonSpriteset);
	register_api_func(g_duk, NULL, "SetPersonValue", js_SetPersonValue);
	register_api_func(g_duk, NULL, "SetPersonVisible", js_SetPersonVisible);
	register_api_func(g_duk, NULL, "SetPersonX", js_SetPersonX);
	register_api_func(g_duk, NULL, "SetPersonXYFloat", js_SetPersonXYFloat);
	register_api_func(g_duk, NULL, "SetPersonY", js_SetPersonY);
	register_api_func(g_duk, NULL, "SetTalkDistance", js_SetTalkDistance);
	register_api_func(g_duk, NULL, "CallDefaultPersonScript", js_CallDefaultPersonScript);
	register_api_func(g_duk, NULL, "CallPersonScript", js_CallPersonScript);
	register_api_func(g_duk, NULL, "ClearPersonCommands", js_ClearPersonCommands);
	register_api_func(g_duk, NULL, "FollowPerson", js_FollowPerson);
	register_api_func(g_duk, NULL, "IgnorePersonObstructions", js_IgnorePersonObstructions);
	register_api_func(g_duk, NULL, "IgnoreTileObstructions", js_IgnoreTileObstructions);
	register_api_func(g_duk, NULL, "QueuePersonCommand", js_QueuePersonCommand);
	register_api_func(g_duk, NULL, "QueuePersonScript", js_QueuePersonScript);
