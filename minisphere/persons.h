...
extern void         get_person_speed        (const person_t* person, float* out_x_speed, float* out_y_speed);
...
extern void         set_person_speed        (person_t* person, float x_speed, float y_speed);
