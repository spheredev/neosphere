...
void       duk_set_class_ptr     (duk_context* ctx, duk_idx_t index, void* udata);
void       duk_to_class_obj      (duk_context* ctx, duk_idx_t index, const char* class_name, void* udata);
