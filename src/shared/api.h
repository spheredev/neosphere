...
void   api_define_function    (const char* namespace_name, const char* name, js_function_t callback, int magic);
void   api_define_method      (const char* class_name, const char* name, js_function_t callback, int magic);
...
void   api_define_subclass    (const char* name, int class_id, int super_id, js_function_t constructor, js_finalizer_t finalizer);
