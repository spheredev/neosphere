 ...
 *
 *  Git commit: e95565c4ac73da0776a27556ec718bd35ea813c3
 *  Git describe: v1.5.0-402-ge95565c
 *  Git branch: master
 *
 *  Supported platforms:
...
#if defined(DUK_OPT_ES6_REGEXP_SYNTAX)
#define DUK_USE_ES6_REGEXP_SYNTAX
#elif defined(DUK_OPT_NO_ES6_REGEXP_SYNTAX)
