...
void                     matrix_orthographic (matrix_t* matrix, float left, float top, float right, float bottom, float z_near, float z_far);
void                     matrix_perspective  (matrix_t* matrix, float left, float top, float right, float bottom, float z_near, float z_far);
