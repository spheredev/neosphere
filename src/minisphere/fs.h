...
vector_t*        game_list_dir     (const game_t* game, const char* dirname, const char* base_dir, bool want_dirs);
bool             game_mkdir        (game_t* game, const char* dirname, const char* base_dir);
void*            game_read_file    (game_t* game, const char* filename, const char* base_dir, size_t *out_size);
bool             game_rename       (game_t* game, const char* filename1, const char* filename2, const char* base_dir);
bool             game_rmdir        (game_t* game, const char* dirname, const char* base_dir);
bool             game_unlink       (game_t* game, const char* filename, const char* base_dir);
bool             game_write_file   (game_t* game, const char* filename, const char* base_dir, const void* buf, size_t size);
file_t*          file_open         (game_t* game, const char* filename, const char* base_dir, const char* mode);
