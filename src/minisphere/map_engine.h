...
void             maps_init         (void);
void             maps_uninit       (void);
bool             maps_running      (void);
...
void         persons_init          (void);
void         persons_uninit        (void);
void         persons_draw_all      (int layer, bool is_flipped, int cam_x, int cam_y);
void         persons_reset         (bool keep_existing);
void         persons_update        (void);
