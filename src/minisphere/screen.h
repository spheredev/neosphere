...
ALLEGRO_BITMAP*  screen_backbuffer        (const screen_t* it);
ALLEGRO_DISPLAY* screen_display           (const screen_t* it);
bool             screen_fullscreen        (const screen_t* it);
bool             screen_have_shaders      (const screen_t* it);
...
void             screen_render_to         (screen_t* it, transform_t* transform);
