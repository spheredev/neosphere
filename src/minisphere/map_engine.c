...
{
	register_api_method(ctx, NULL, "MapEngine", js_MapEngine);
	register_api_method(ctx, NULL, "AreZonesAt", js_AreZonesAt);
	register_api_method(ctx, NULL, "IsCameraAttached", js_IsCameraAttached);
	register_api_method(ctx, NULL, "IsInputAttached", js_IsInputAttached);
	register_api_method(ctx, NULL, "IsLayerReflective", js_IsLayerReflective);
	register_api_method(ctx, NULL, "IsLayerVisible", js_IsLayerVisible);
	register_api_method(ctx, NULL, "IsMapEngineRunning", js_IsMapEngineRunning);
	register_api_method(ctx, NULL, "IsTriggerAt", js_IsTriggerAt);
	register_api_method(ctx, NULL, "GetCameraPerson", js_GetCameraPerson);
	register_api_method(ctx, NULL, "GetCameraX", js_GetCameraX);
	register_api_method(ctx, NULL, "GetCameraY", js_GetCameraY);
	register_api_method(ctx, NULL, "GetCurrentMap", js_GetCurrentMap);
	register_api_method(ctx, NULL, "GetCurrentTrigger", js_GetCurrentTrigger);
	register_api_method(ctx, NULL, "GetCurrentZone", js_GetCurrentZone);
	register_api_method(ctx, NULL, "GetInputPerson", js_GetInputPerson);
	register_api_method(ctx, NULL, "GetLayerHeight", js_GetLayerHeight);
	register_api_method(ctx, NULL, "GetLayerMask", js_GetLayerMask);
	register_api_method(ctx, NULL, "GetLayerWidth", js_GetLayerWidth);
	register_api_method(ctx, NULL, "GetMapEngineFrameRate", js_GetMapEngineFrameRate);
	register_api_method(ctx, NULL, "GetNextAnimatedTile", js_GetNextAnimatedTile);
	register_api_method(ctx, NULL, "GetNumLayers", js_GetNumLayers);
	register_api_method(ctx, NULL, "GetNumTiles", js_GetNumTiles);
	register_api_method(ctx, NULL, "GetNumTriggers", js_GetNumTriggers);
	register_api_method(ctx, NULL, "GetNumZones", js_GetNumZones);
	register_api_method(ctx, NULL, "GetTalkActivationButton", js_GetTalkActivationButton);
	register_api_method(ctx, NULL, "GetTalkActivationKey", js_GetTalkActivationKey);
	register_api_method(ctx, NULL, "GetTile", js_GetTile);
	register_api_method(ctx, NULL, "GetTileDelay", js_GetTileDelay);
	register_api_method(ctx, NULL, "GetTileImage", js_GetTileImage);
	register_api_method(ctx, NULL, "GetTileHeight", js_GetTileHeight);
	register_api_method(ctx, NULL, "GetTileName", js_GetTileName);
	register_api_method(ctx, NULL, "GetTileSurface", js_GetTileSurface);
	register_api_method(ctx, NULL, "GetTileWidth", js_GetTileWidth);
	register_api_method(ctx, NULL, "GetTriggerLayer", js_GetTriggerLayer);
	register_api_method(ctx, NULL, "GetTriggerX", js_GetTriggerX);
	register_api_method(ctx, NULL, "GetTriggerY", js_GetTriggerY);
	register_api_method(ctx, NULL, "GetZoneHeight", js_GetZoneHeight);
	register_api_method(ctx, NULL, "GetZoneLayer", js_GetZoneLayer);
	register_api_method(ctx, NULL, "GetZoneSteps", js_GetZoneSteps);
	register_api_method(ctx, NULL, "GetZoneWidth", js_GetZoneWidth);
	register_api_method(ctx, NULL, "GetZoneX", js_GetZoneX);
	register_api_method(ctx, NULL, "GetZoneY", js_GetZoneY);
	register_api_method(ctx, NULL, "SetCameraX", js_SetCameraX);
	...
	register_api_method(ctx, NULL, "SetTalkActivationButton", js_SetTalkActivationButton);
	register_api_method(ctx, NULL, "SetTalkActivationKey", js_SetTalkActivationKey);
	register_api_method(ctx, NULL, "SetTile", js_SetTile);
	register_api_method(ctx, NULL, "SetTileDelay", js_SetTileDelay);
	register_api_method(ctx, NULL, "SetTileImage", js_SetTileImage);
	register_api_method(ctx, NULL, "SetTileName", js_SetTileName);
	register_api_method(ctx, NULL, "SetTileSurface", js_SetTileSurface);
	register_api_method(ctx, NULL, "SetTriggerLayer", js_SetTriggerLayer);
	register_api_method(ctx, NULL, "SetTriggerScript", js_SetTriggerScript);
	register_api_method(ctx, NULL, "SetTriggerXY", js_SetTriggerXY);
	register_api_method(ctx, NULL, "SetUpdateScript", js_SetUpdateScript);
	register_api_method(ctx, NULL, "SetZoneLayer", js_SetZoneLayer);
	register_api_method(ctx, NULL, "SetZoneMetrics", js_SetZoneMetrics);
	register_api_method(ctx, NULL, "SetZoneScript", js_SetZoneScript);
	register_api_method(ctx, NULL, "SetZoneSteps", js_SetZoneSteps);
	register_api_method(ctx, NULL, "AddTrigger", js_AddTrigger);
	register_api_method(ctx, NULL, "AddZone", js_AddZone);
	register_api_method(ctx, NULL, "AttachCamera", js_AttachCamera);
	register_api_method(ctx, NULL, "AttachInput", js_AttachInput);
	register_api_method(ctx, NULL, "AttachPlayerInput", js_AttachPlayerInput);
	register_api_method(ctx, NULL, "CallDefaultMapScript", js_CallDefaultMapScript);
	register_api_method(ctx, NULL, "CallMapScript", js_CallMapScript);
	register_api_method(ctx, NULL, "ChangeMap", js_ChangeMap);
	register_api_method(ctx, NULL, "DetachCamera", js_DetachCamera);
	register_api_method(ctx, NULL, "DetachInput", js_DetachInput);
	register_api_method(ctx, NULL, "DetachPlayerInput", js_DetachPlayerInput);
	register_api_method(ctx, NULL, "ExecuteTrigger", js_ExecuteTrigger);
	register_api_method(ctx, NULL, "ExecuteZones", js_ExecuteZones);
	register_api_method(ctx, NULL, "ExitMapEngine", js_ExitMapEngine);
	register_api_method(ctx, NULL, "MapToScreenX", js_MapToScreenX);
	register_api_method(ctx, NULL, "MapToScreenY", js_MapToScreenY);
	register_api_method(ctx, NULL, "RemoveTrigger", js_RemoveTrigger);
	register_api_method(ctx, NULL, "RemoveZone", js_RemoveZone);
	register_api_method(ctx, NULL, "RenderMap", js_RenderMap);
	register_api_method(ctx, NULL, "ReplaceTilesOnLayer", js_ReplaceTilesOnLayer);
	register_api_method(ctx, NULL, "ScreenToMapX", js_ScreenToMapX);
	register_api_method(ctx, NULL, "ScreenToMapY", js_ScreenToMapY);
	register_api_method(ctx, NULL, "SetDelayScript", js_SetDelayScript);
	register_api_method(ctx, NULL, "UpdateMapEngine", js_UpdateMapEngine);
