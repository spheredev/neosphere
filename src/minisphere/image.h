...
matrix_t*       image_get_transform      (const image_t* image);
void            image_set_transform      (image_t* image, matrix_t* transform);
...
void            image_render_to          (image_t* image, matrix_t* transform);
