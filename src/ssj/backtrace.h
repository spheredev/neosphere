...
int          backtrace_get_lineno   (const backtrace_t* obj, int index);
const char*  backtrace_get_name     (const backtrace_t* obj, int index);
void         backtrace_add          (backtrace_t* obj, const char* name, const char* filename, int line_no);
