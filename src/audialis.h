...
extern stream_t* create_stream    (int frequency, int bits, int channels);
extern stream_t* ref_stream       (stream_t* stream);
extern void      free_stream      (stream_t* stream);
extern mixer_t*  get_stream_mixer (stream_t* stream);
extern void      set_stream_mixer (stream_t* stream, mixer_t* mixer);
...
extern mixer_t*  get_sound_mixer   (sound_t* sound);
...
extern void      set_sound_mixer   (sound_t* sound, mixer_t* mixer);
