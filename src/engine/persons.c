...
init_persons_api(void)
{
	...
	api_register_method(g_duk, NULL, "CreatePerson", js_CreatePerson);
	api_register_method(g_duk, NULL, "DestroyPerson", js_DestroyPerson);
	api_register_method(g_duk, NULL, "IsCommandQueueEmpty", js_IsCommandQueueEmpty);
	api_register_method(g_duk, NULL, "IsIgnoringPersonObstructions", js_IsIgnoringPersonObstructions);
	api_register_method(g_duk, NULL, "IsIgnoringTileObstructions", js_IsIgnoringTileObstructions);
	api_register_method(g_duk, NULL, "IsPersonObstructed", js_IsPersonObstructed);
	api_register_method(g_duk, NULL, "IsPersonVisible", js_IsPersonVisible);
	api_register_method(g_duk, NULL, "DoesPersonExist", js_DoesPersonExist);
	api_register_method(g_duk, NULL, "GetActingPerson", js_GetActingPerson);
	api_register_method(g_duk, NULL, "GetCurrentPerson", js_GetCurrentPerson);
	api_register_method(g_duk, NULL, "GetObstructingPerson", js_GetObstructingPerson);
	api_register_method(g_duk, NULL, "GetObstructingTile", js_GetObstructingTile);
	api_register_method(g_duk, NULL, "GetPersonAngle", js_GetPersonAngle);
	api_register_method(g_duk, NULL, "GetPersonBase", js_GetPersonBase);
	api_register_method(g_duk, NULL, "GetPersonData", js_GetPersonData);
	api_register_method(g_duk, NULL, "GetPersonDirection", js_GetPersonDirection);
	api_register_method(g_duk, NULL, "GetPersonFollowDistance", js_GetPersonFollowDistance);
	api_register_method(g_duk, NULL, "GetPersonFollowers", js_GetPersonFollowers);
	api_register_method(g_duk, NULL, "GetPersonFrame", js_GetPersonFrame);
	api_register_method(g_duk, NULL, "GetPersonFrameNext", js_GetPersonFrameNext);
	api_register_method(g_duk, NULL, "GetPersonFrameRevert", js_GetPersonFrameRevert);
	api_register_method(g_duk, NULL, "GetPersonIgnoreList", js_GetPersonIgnoreList);
	api_register_method(g_duk, NULL, "GetPersonLayer", js_GetPersonLayer);
	api_register_method(g_duk, NULL, "GetPersonLeader", js_GetPersonLeader);
	api_register_method(g_duk, NULL, "GetPersonList", js_GetPersonList);
	api_register_method(g_duk, NULL, "GetPersonMask", js_GetPersonMask);
	api_register_method(g_duk, NULL, "GetPersonOffsetX", js_GetPersonOffsetX);
	api_register_method(g_duk, NULL, "GetPersonOffsetY", js_GetPersonOffsetY);
	api_register_method(g_duk, NULL, "GetPersonSpeedX", js_GetPersonSpeedX);
	api_register_method(g_duk, NULL, "GetPersonSpeedY", js_GetPersonSpeedY);
	api_register_method(g_duk, NULL, "GetPersonSpriteset", js_GetPersonSpriteset);
	api_register_method(g_duk, NULL, "GetPersonValue", js_GetPersonValue);
	api_register_method(g_duk, NULL, "GetPersonX", js_GetPersonX);
	api_register_method(g_duk, NULL, "GetPersonXFloat", js_GetPersonXFloat);
	api_register_method(g_duk, NULL, "GetPersonY", js_GetPersonY);
	api_register_method(g_duk, NULL, "GetPersonYFloat", js_GetPersonYFloat);
	api_register_method(g_duk, NULL, "GetTalkDistance", js_GetTalkDistance);
	api_register_method(g_duk, NULL, "SetDefaultPersonScript", js_SetDefaultPersonScript);
	api_register_method(g_duk, NULL, "SetPersonAngle", js_SetPersonAngle);
	api_register_method(g_duk, NULL, "SetPersonData", js_SetPersonData);
	api_register_method(g_duk, NULL, "SetPersonDirection", js_SetPersonDirection);
	api_register_method(g_duk, NULL, "SetPersonFollowDistance", js_SetPersonFollowDistance);
	api_register_method(g_duk, NULL, "SetPersonFrame", js_SetPersonFrame);
	api_register_method(g_duk, NULL, "SetPersonFrameNext", js_SetPersonFrameNext);
	api_register_method(g_duk, NULL, "SetPersonFrameRevert", js_SetPersonFrameRevert);
	api_register_method(g_duk, NULL, "SetPersonIgnoreList", js_SetPersonIgnoreList);
	api_register_method(g_duk, NULL, "SetPersonLayer", js_SetPersonLayer);
	api_register_method(g_duk, NULL, "SetPersonMask", js_SetPersonMask);
	api_register_method(g_duk, NULL, "SetPersonOffsetX", js_SetPersonOffsetX);
	api_register_method(g_duk, NULL, "SetPersonOffsetY", js_SetPersonOffsetY);
	api_register_method(g_duk, NULL, "SetPersonScaleAbsolute", js_SetPersonScaleAbsolute);
	api_register_method(g_duk, NULL, "SetPersonScaleFactor", js_SetPersonScaleFactor);
	api_register_method(g_duk, NULL, "SetPersonScript", js_SetPersonScript);
	api_register_method(g_duk, NULL, "SetPersonSpeed", js_SetPersonSpeed);
	api_register_method(g_duk, NULL, "SetPersonSpeedXY", js_SetPersonSpeedXY);
	api_register_method(g_duk, NULL, "SetPersonSpriteset", js_SetPersonSpriteset);
	api_register_method(g_duk, NULL, "SetPersonValue", js_SetPersonValue);
	api_register_method(g_duk, NULL, "SetPersonVisible", js_SetPersonVisible);
	api_register_method(g_duk, NULL, "SetPersonX", js_SetPersonX);
	api_register_method(g_duk, NULL, "SetPersonXYFloat", js_SetPersonXYFloat);
	api_register_method(g_duk, NULL, "SetPersonY", js_SetPersonY);
	api_register_method(g_duk, NULL, "SetTalkDistance", js_SetTalkDistance);
	api_register_method(g_duk, NULL, "CallDefaultPersonScript", js_CallDefaultPersonScript);
	api_register_method(g_duk, NULL, "CallPersonScript", js_CallPersonScript);
	api_register_method(g_duk, NULL, "ClearPersonCommands", js_ClearPersonCommands);
	api_register_method(g_duk, NULL, "FollowPerson", js_FollowPerson);
	api_register_method(g_duk, NULL, "IgnorePersonObstructions", js_IgnorePersonObstructions);
	api_register_method(g_duk, NULL, "IgnoreTileObstructions", js_IgnoreTileObstructions);
	api_register_method(g_duk, NULL, "QueuePersonCommand", js_QueuePersonCommand);
