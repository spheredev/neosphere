...
init_bytearray_api(void)
{
	...
	api_register_method(g_duk, "ByteArray", "concat", js_ByteArray_concat);
	api_register_method(g_duk, "ByteArray", "deflate", js_ByteArray_deflate);
	api_register_method(g_duk, "ByteArray", "inflate", js_ByteArray_inflate);
	api_register_method(g_duk, "ByteArray", "slice", js_ByteArray_slice);
}
