...
{
    assert(typeof mean === 'number', "mean must be a number");
    assert(typeof sigma === 'number', "sigma must be a number");
...
{
    assert(typeof mean === 'number', "mean must be a number");
    assert(typeof variance === 'number', "variance must be a number");
